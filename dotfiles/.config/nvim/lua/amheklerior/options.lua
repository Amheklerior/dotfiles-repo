...
--  to override some of these only for specific type of files, create a file into the
--  /after/ftplugin directory into the root dir (.config/nvim), for that specific filetype.
